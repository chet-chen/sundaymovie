...
class ComingAdapter extends RecyclerView.Adapter<ComingAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener, View.OnCreateContextMenuListener {
        ...
        ViewHolder(View itemView) {
            ...
            mTVTitle = itemView.findViewById(R.id.tv_movie_t);
            mTVDate = itemView.findViewById(R.id.tv_movie_date);
            mTVType = itemView.findViewById(R.id.tv_movie_type);
            mTVDirecto = itemView.findViewById(R.id.tv_movie_director);
            mTVActor = itemView.findViewById(R.id.tv_movie_actor);
        }
        ...
        void bindMovie(ComingMovie movie) {
            ...
            if (!mMovie.getActor1().isEmpty()) {
                mTVActor.setText("主演: " + mMovie.getActor1() + movie.getActor2());
            }
